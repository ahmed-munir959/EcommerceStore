...
//     const val = contact.trim();
//     if (!val) {
//       setMessage({ text: "Enter email or phone", type: "error" });
//       clearMessage();
//       return;
//     }
//     if (!isEmail(val) && !isPhone(val)) {
//       setMessage({ text: "Enter valid email or phone number", type: "error" });
//       clearMessage();
//       return;
//     }
//     if (!password || password.length < 6) {
...
//           {/* Top message */}
//           {message.type && (
//             <div className={`p-3 rounded-sm text-sm ${message.type === "success" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}>
//               {message.text}
//             </div>
//           )}
